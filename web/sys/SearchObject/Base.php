...
abstract class SearchObject_Base
{
    ...
    protected function initBasicSearch()
    {
        ...
        if($this->debug){
        	echo "<br><b>ZDB: Base.php BasicSearch REQUEST</b><br>";
        	print_r($_REQUEST);
        	echo "<br>";
			echo "ZDB: Base.php BasicSearch searchTerms<br>";
    ...
    protected function initAdvancedSearch()
    {
        ...
        if($this->debug){
        	echo "<br><b>ZDB: Base.php initAdvancedSearch REQUEST</b><br><pre>";
        	print_r($_REQUEST);
        	echo "</pre><br>";
			echo "<br><b>ZDB: Base.php initAdvancedSearch searchTerms</b><br><pre>";
			print_r($this->searchTerms);
			echo "</pre><br>";
        }
    }
